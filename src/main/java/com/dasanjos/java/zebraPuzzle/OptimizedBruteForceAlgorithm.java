 ...
 * Cut the impossible solutions from inception (based on rules), evaluating only possible combinations.
 */
public class OptimizedBruteForceAlgorithm extends ZebraPuzzle {
